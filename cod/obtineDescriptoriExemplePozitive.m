...
disp(['Exista un numar de exemple pozitive = ' num2str(numarImagini)]);pause(2);
    ...
    descriptorImg=vl_hog(single(img),parametri.dimensiuneCelulaHOG);
    [nrCeluleV,nrCeluleO,dimDescCelulelor]=size(descriptorImg);
    %6 6 31
    descriptoriExemplePozitive(idx,:)= reshape(descriptorImg,1,nrCeluleV*nrCeluleO*dimDescCelulelor);
    end
